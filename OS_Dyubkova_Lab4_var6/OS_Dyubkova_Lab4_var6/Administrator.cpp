...
int main()
{
    ...
    for (int i = 0; i < nWriterProcs; i++)
    {
        ...
        if (!CreateProcessW(L"D:/Temp/OS_Dyubkova_Lab4_var6/Debug/Writer.exe", lpszCommandLine, NULL, NULL, FALSE,
    ...
    for (int i = 0; i < nReaderProcs; i++)
    {
        ...
        //Создаем процесс
        if (!CreateProcessW(L"D:/Temp/OS_Dyubkova_Lab4_var6/Debug/Reader.exe", lpszCommandLine, NULL, NULL, FALSE,
